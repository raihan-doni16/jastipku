...
const testimonials = [
  {
    ...
    city: "Jakarta",
    rating: 5,
    comment: "Barangnya datang tepat waktu dan prosesnya jelas banget dari awal. Recommended!"
  },
  {
    name: "Andi Wijaya",
    city: "Surabaya",
    rating: 4,
    comment: "Admin komunikatif, biaya transparan. Bisa update status kapan saja."
  },
  {
    name: "Mega Saras",
    city: "Bandung",
...
export {
  ...
  jastiperOrders as b,
  chatHistory as c,
  jastiperTransactions as j,
  kpis as k,
  listings as l,
  myReviews as m,
  orders as o,
  popularCountries as p,
  statusMeta as s,
  testimonials as t,
  users as u
};
